        ...
        {data.map((item) => (
          <SwiperSlide key={item.id}>
            <div className="relative h-full w-full group">
              {/* Background Image */}
              <img
                src="https://i.ibb.co.com/W4HM7q4K/coolbackgrounds-particles-stellar.png"
                alt={item.title}
              ...
              {/* CONTENT WRAPPER (Left Text + Right Image) */}
              <div className="absolute inset-0 flex items-center justify-between px-10">
                ...
                {/* RIGHT SIDE → Image inside a DIV */}
                <div className="w-40 h-56 rounded-xl overflow-hidden shadow-2xl border border-white/20">
                  <img
                    src={item.image}
                    alt={item.title}
